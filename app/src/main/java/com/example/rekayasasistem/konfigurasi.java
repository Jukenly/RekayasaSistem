...
public class konfigurasi {
    ...
    public static final String URL_ADD="https://apirekayasa.000webhostapp.com/tambahPgw.php";
    public static final String URL_GET_ALL = "https://apirekayasa.000webhostapp.com/tampilSemuaPgw.php";
    public static final String URL_GET_EMP = "https://apirekayasa.000webhostapp.com/tampilPgw.php?id=";
    public static final String URL_UPDATE_EMP = "https://apirekayasa.000webhostapp.com/updatePgw.php";
    public static final String URL_DELETE_EMP = "https://apirekayasa.000webhostapp.com/hapusPgw.php?id=";
