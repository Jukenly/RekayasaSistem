    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String noinduk = jo.getString(konfigurasi.TAG_NOINDUK);
                String name = jo.getString(konfigurasi.TAG_NAMA);
                HashMap<String,String> employees = new HashMap<>();
                employees.put(konfigurasi.TAG_ID,id);
                employees.put(konfigurasi.TAG_NOINDUK,noinduk);
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                new String[]{konfigurasi.TAG_ID,konfigurasi.TAG_NOINDUK,konfigurasi.TAG_NAMA},
                new int[]{R.id.id,R.id.noinduk, R.id.name});
